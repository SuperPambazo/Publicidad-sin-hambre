...
@section('title')
    Información de la Asociación - World Food Programme (WFP)
@endsection

@section('content')
<section class="informacion-asociacion">
    <div class="info-container">
        <h1 class="text-center mb-4">World Food Programme (WFP)</h1>
        <div class="info-layout">
            <!-- Card para la imagen grande -->
            <div class="info-image-card">
            <img src="{{ asset('imagenes/vecteezy_team-of-young-and-diversity-volunteer-worker-group-enjoy_11273559.jpg') }}" alt="ONG 1" class="info-image">    
            </div>
