...
<section class="informacion-asociacion">
    <div class="info-container">
        ...
        <div class="info-layout">
            ...
            <img src="{{ asset('imagenes/close-up-people-volunteer-teamwork-putting-finger-star-shapehands-togetherstack-handsunity-teamwork-world-environment-day.jpg') }}" alt="ONG 1" class="info-image">    
            </div>
